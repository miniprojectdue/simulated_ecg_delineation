"""Shared palette and rcParams for the Chapter 4 figures.

Red is the QRS complex, green the T wave, purple the P wave, and
blue is the general-purpose series colour that figure already uses for its lead bars.
"""
