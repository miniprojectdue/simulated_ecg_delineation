...
REC, LEAD, UNIT = 'InferiorInfarction_008', 'V2', 'simulator units'
CSVDIR = 'ml_modelling/results'
PANELS = [
    (CSVDIR + '/zeroshot_heldout50_2/per_unit.csv',
     '(a) inferior infarction, lead V2 — zero-shot, no adaptation'),
    (CSVDIR + '/fewshot_ext_adapted2/per_unit.csv',
     '(b) inferior infarction, lead V2 — label-supervised adaptation'),
    (CSVDIR + '/fewshot_ext_adapted5/per_unit.csv',
     '(c) inferior infarction, lead V2 — distilled adaptation'),
]
...
fig.legend(handles=handles, loc='lower center', bbox_to_anchor=(0.5, -0.035),
           ncol=3, borderaxespad=0, handlelength=1.5, handleheight=0.85, columnspacing=1.6)
